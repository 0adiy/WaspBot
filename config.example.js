const config = {
  ...
  // Set your guilds as key value (name, discord guild id) pairs here that can be easily addressed by eval command for superusers
  guilds: {
    waspbotDev: "1060639542249521203", // WaspBot Dev Server
  },
